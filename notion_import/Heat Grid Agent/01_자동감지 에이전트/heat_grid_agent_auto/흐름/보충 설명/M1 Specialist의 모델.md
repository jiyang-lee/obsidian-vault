...
## 요약
- 이 문서는 `![[Pasted image 20260706162013.png]]`를 중심으로 정리된 세부 설명입니다.
- 관련 문서: `Pasted image 20260706162013.png`, `Gate`, `LogisticRegression_balanced`
...
이 모델은 [LogisticRegression_balanced](LogisticRegression_balanced.md)이고, threshold가 0.6이다.
