...
## 요약
- 이 문서는 `: 입력-M1 Specialist-우선순위`를 중심으로 정리된 세부 설명입니다.
- 관련 문서: `Pasted image 20260706155612.png`, `6시간 윈도우`, `M1 Specialist의 모델`, `M1 Specialist Priority 점수`
...
- 앞단에서 [6시간 윈도우](보충 설명/6시간 윈도우.md)에 맞는 window_end로부터 계산
...
[M1 Specialist의 모델](보충 설명/M1 Specialist의 모델.md)은 4개이다.
...
---
# 3. [M1 Specialist Priority 점수](보충 설명/M1 Specialist Priority 점수.md)
...
| [fault_group_weight](보충 설명/fault_group_weight.md)  | 0.15 | 고장군별 운영 중요도 보정          |
```
